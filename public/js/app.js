...
exports.default = {
    ...
    methods: {
         ...
         */
        createNewIntervention: function createNewIntervention() {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  var id = "/var/www/html/dentsmart/resources/assets/js/components/CreateNewIntervention.vue"
  if (!module.hot.data) {
...
},{"vue":38,"vue-hot-reload-api":13}],41:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    methods: {
         ...
         */
        deleteIntervention: function deleteIntervention(interventionId) {
         ...
         * @returns {boolean}
         */
        askForConfirmation: function askForConfirmation(callback) {
            swal({
                title: 'Sunteţi sigur?',
...
},{"vue":38,"vue-hot-reload-api":13}],42:[function(require,module,exports){
'use strict';
...
var _CreateNewIntervention = require('../components/CreateNewIntervention.vue');

var _CreateNewIntervention2 = _interopRequireDefault(_CreateNewIntervention);
...
exports.default = {
    ...
    components: {
        ...
        'create-new-intervention': _CreateNewIntervention2.default,
    ...
    events: {
         ...
         */
        'interventions_updated': function interventions_updated() {
...
},{"../components/Intervention.vue":41,"../components/Paginator.vue":45,"vue":38,"vue-hot-reload-api":13}],44:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "/var/www/html/dentsmart/resources/assets/js/components/LogIn.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"vue":38,"vue-hot-reload-api":13}],45:[function(require,module,exports){
'use strict';
...
},{"vue":38,"vue-hot-reload-api":13}],46:[function(require,module,exports){
'use strict';
